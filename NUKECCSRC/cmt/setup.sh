...
${CMTROOT}/mgr/cmt setup -sh -pack=NUKECCSRC -version=${MINERVA_RELEASE} -path=/minerva/app/users/anezkak/cmtuser/Minerva_v22r1p1_MADNew/Ana/NSFNukeCCInclusive  -no_cleanup $* >${tempfile}; . ${tempfile}
/bin/rm -f ${tempfile}
