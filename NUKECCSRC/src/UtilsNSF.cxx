...
std::vector<std::string> NukeCCUtilsNSF::GetStdPlaylists( HelicityType::t_HelicityType helicity ) const
{
    ...
    if( HelicityType::kAntiNeutrino != helicity )
    {
        ...
        playlists.push_back( "minervame6C" );
        playlists.push_back( "minervame6D" );
        playlists.push_back( "minervame6E" );
        playlists.push_back( "minervame6F" );
        playlists.push_back( "minervame6G" );
        ...
        playlists.push_back( "minervame1B" );
        playlists.push_back( "minervame1C" );
        playlists.push_back( "minervame1D" );
        playlists.push_back( "minervame1E" );
        playlists.push_back( "minervame1F" );
        playlists.push_back( "minervame1G" );
        playlists.push_back( "minervame1L" );
        playlists.push_back( "minervame1M" );
        playlists.push_back( "minervame1N" );
        playlists.push_back( "minervame1O" );
        playlists.push_back( "minervame1P" );
...
HelicityType::t_HelicityType NukeCCUtilsNSF::GetHelicityFromPlaylist( std::string playlist ) const
{
 ...
 //       playlist = fPlaylist;
       ...
       if (Playlist::minervame5A == playlist ||
        ...
        Playlist::minervame6C == playlist    ||
        Playlist::minervame6D == playlist    ||
        Playlist::minervame6E == playlist    ||
        Playlist::minervame6F == playlist    ||
        Playlist::minervame6G == playlist    ||
        Playlist::minervame6H == playlist    ||
        Playlist::minervame6I == playlist    ||
        Playlist::minervame6J == playlist    
        ) {
