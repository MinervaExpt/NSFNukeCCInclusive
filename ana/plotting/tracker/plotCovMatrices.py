...
steps = ["total_cov_matrix", "stat_cov_matrix", "unfold_cov_matrix", 'stat_err_matrix']
vars = ["Enu", "x"]
prefixes = ['data']#, 'mc']
...
for step in steps:
        for prefix in prefixes:
                for var in vars:
                        ...
                        mc_hist.SetMaximum((1.1*mc_hist.GetMaximum()))
                        ...
                        mc_hist.GetZaxis().SetTitle("Bin-to-bin covariance")
                        mc_hist.Draw("COLZ")
