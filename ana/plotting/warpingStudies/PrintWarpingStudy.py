...
for fileName in sys.argv[1:]:
    ...
    spread.GetXaxis().SetRangeUser(1, 20)
    spread.Draw("colz")
    ...
    ndfLine = ROOT.TLine(1, yNDF, 20, yNDF)
    ...
    mnv.AddHistoTitle("Fake Data == DeuteriumGeniePiTune: Bjorken x ", 0.04, 1)
    can.Print(fileName + "2.png")