...
for var in vars:
    ...
    '''
    mc_hist.PopVertErrorBand("response_tracker_high_proton")
    mc_hist.PopVertErrorBand("response_nucl_high_proton")
    mc_hist.PopVertErrorBand("response_hcal_high_proton")
    mc_hist.PopVertErrorBand("response_ecal_high_proton")

    mc_hist.PopVertErrorBand("response_tracker_mid_proton")
    mc_hist.PopVertErrorBand("response_nucl_mid_proton")
    mc_hist.PopVertErrorBand("response_hcal_mid_proton")
    mc_hist.PopVertErrorBand("response_ecal_mid_proton")

    mc_hist.PopVertErrorBand("response_tracker_low_proton")
    mc_hist.PopVertErrorBand("response_nucl_low_proton")
    mc_hist.PopVertErrorBand("response_hcal_low_proton")
    mc_hist.PopVertErrorBand("response_ecal_low_proton")

    mc_hist.PopVertErrorBand("response_tracker_em")
    mc_hist.PopVertErrorBand("response_nucl_em")
    mc_hist.PopVertErrorBand("response_hcal_em")
    mc_hist.PopVertErrorBand("response_ecal_em")

    mc_hist.PopVertErrorBand("response_tracker_other")
    mc_hist.PopVertErrorBand("response_nucl_other")
    mc_hist.PopVertErrorBand("response_hcal_other")
    mc_hist.PopVertErrorBand("response_ecal_other")
    ...
    for k in keys:
        if(k.ClassName().find("TH1")!=-1):
            ...
            if var == "ThetamuDeg":
                k.GetYaxis().SetRangeUser(0,k.GetMaximum()*1.05)
            if var == "ThetamuDeg":
                k.GetYaxis().SetRangeUser(0,k.GetMaximum()*0.5)
    ...
    canvas1.Modified()
    canvas1.Print("EventSelection_t%s_z%02s_%s_%s_FracErr_poppedExceptMeson.png"%(targetID, targetZ, var, plist))
