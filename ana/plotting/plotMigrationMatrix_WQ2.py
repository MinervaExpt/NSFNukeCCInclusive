...
infile= ROOT.TFile(str(dirpwd)+"/Migration_%s_t%s_z%02s_sys.root"%(plist, targetID, targetZ))
...
for var in vars:
        ...
        if var == "W":
                mc_hist.GetXaxis().SetTitle("Reconstructed W bin number")
                mc_hist.GetYaxis().SetTitle("True W bin number")
                mc_hist.SetMarkerSize(1.2)
                new.GetXaxis().SetTitle("Reconstructed W (GeV)")
                new.GetYaxis().SetTitle("True W (GeV)")
                new.SetMarkerSize(1.2)

        if var == "Q2":
                mc_hist.GetXaxis().SetTitle("Reconstructed Q^{2} bin number")
                mc_hist.GetYaxis().SetTitle("True Q^{2} bin number")
                mc_hist.SetMarkerSize(1.2)
                new.GetXaxis().SetTitle("Reconstructed Q^{2}  GeV^{2}")
                new.GetYaxis().SetTitle("True Q^{2} GeV^{2}")
                new.SetMarkerSize(1.2)
        ...
        canvas1.Print("Migration_%s_t%s_z%02s_%s_Occupancy.png"%(plist, targetID, targetZ, var))
        ...
        canvas1.Print("Migration_%s_t%s_z%02s_%s_Occupancy_Binned.png"%(plist, targetID, targetZ, var))
        ...
        if targetZ == "99":
                ...
                mnv.AddHistoTitle("Target %s %s"%(targetID, trueZ), 0.05, 1)
        canvas1.Print("Migration_%s_t%s_z%02s_%s_ColumnNorm.png"%(plist, targetID, targetZ, var))
        ...
        if targetZ == "99":
                ...
                mnv.AddHistoTitle("Target %s %s"%(targetID, trueZ), 0.05, 1)
        canvas1.Print("Migration_%s_t%s_z%02s_%s_ColumnNorm_Binned.png"%(plist, targetID, targetZ, var))
        ...
        if targetZ == "99":
                ...
                mnv.AddHistoTitle("Target %s %s"%(targetID, trueZ), 0.05, 1)
        canvas1.Print("Migration_%s_t%s_z%02s_%s_RowNorm.png"%(plist, targetID, targetZ, var))
        ...
        if targetZ == "99":
                ...
                mnv.AddHistoTitle("Target %s %s"%(targetID, trueZ), 0.05, 1)
        canvas1.Print("Migration_%s_t%s_z%02s_%s_RowNorm_Binned.png"%(plist, targetID, targetZ, var))
