...
class Variable : public PlotUtils::VariableBase<NUKECC_ANA::CVUniverse> {
 ...
 public:
  ...
  HW m_selected_mc_reco, m_selected_mc_truth, m_selected_mc_reco_bkg,m_selected_data_reco, m_selected_mc_reco_signal;
  // HISTFOLIO
  ...
  void InitializeAllHistograms(T univs) {
    ...
    MH1D* dummy_selected_mc_truth = new MH1D(Form("selected_mc_truth_%s", name), name,
                                      GetNBins(), bins.data());
