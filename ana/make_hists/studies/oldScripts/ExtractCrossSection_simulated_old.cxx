...
------"<<std::endl;
  ...
  for(const auto&var: vars){
    ...
    auto fluxRebinned = frw.GetRebinnedFluxReweighted(-14, effDenom);
    ...
    auto simCrossSection_total = normalizeTotal(effDenom, fluxRebinned, nNucleons, mcpot);
    //Plot(*crossSection_mc, "crossSection_mc", prefix);
    simCrossSection_total->Clone()->Write(Form("simCrossSection_total_%s", var.c_str() ));
