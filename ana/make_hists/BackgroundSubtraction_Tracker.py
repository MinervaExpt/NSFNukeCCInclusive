...
infile = ROOT.TFile("/minerva/data2/users/anezkak/ME6A_Tracker/Hists_EventSelectionTracker_ML_ME6A_sys_t99_z99_AntiNu.root","READ")
...
out1 = ROOT.TFile("BackgroundSubtracted_EventSelection_bkgSubtract_tracker.root","RECREATE")
vars = ["Enu", "x"]
