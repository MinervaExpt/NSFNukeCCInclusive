...
int main(int argc, char *argv[]){
   ...
   bool doDIS=false;
    ...
    //const std::string mc_file_list("../../include/playlists/ML_NukeCC_ME6A_mc.txt");
    //const std::string data_file_list("../../include/playlists/ML_NukeCC_ME6A_data.txt");
...
//------------------------------------------------------------PLASTIC SB STUFF END-------------------
	 ...
	 if( dataverse->GetVecElem("ANN_plane_probs",0) < MIN_PROB_PLANE_CUT ) continue;	   
         reco3++;
           ...
           if( targetID == 1 && dataverse-> Var("planeDNN") <= dataverse->GetTargetUSPlane(targetID) ) continue; //NEW
         reco4++;
