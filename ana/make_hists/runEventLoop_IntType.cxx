...
int main(int argc, char *argv[]){
  ...
  if(RunCodeWithSystematics){
    histFileName = utils->GetHistFileName( "EventSelectionIntType_ML_ME6A_sys", FileType::kAny, targetID, targetZ, helicity ); 
  }

  else{
    histFileName = utils->GetHistFileName( "EventSelectionIntType_ML_ME6A_nosys", FileType::kAny, targetID, targetZ, helicity ); 
  } 
            ...
            for (auto universe : error_band_universes){
              ...
              for (auto v : variables2d){
                ...
                if (universe->GetInt("mc_intType") == 1){ // QE
                  ...
                  v->m_selected_mc_sb.GetComponentHist("RES")->Fill(v->GetRecoValue(*universe, 0), universe->GetWeight());
                  RES++;
                }
                  ...
                  v->m_selected_mc_sb.GetComponentHist("2p2h")->Fill(v->GetRecoValue(*universe, 0), universe->GetWeight());
                  npnh++;
                }
                else{ // other
