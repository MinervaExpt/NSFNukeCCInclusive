...
void makePlots(int petal, bool doMultipliers,bool doRatio, string indir, string outdir, int targetID, int targetZ, string plist, int combined)
{
  ...
  if(doRatio){
    ...
    gc->Print(doMultipliers ? Form("%s/EventSelection2D_daisy_t%d_z%02d_%s_pt_p%d_multiplier.png", outdir.c_str(), targetID, targetZ, plist.c_str(), petal) : Form("%s/EventSelection2D_daisy_t%d_z%02d_%s_pt_p%d.png", outdir.c_str(), targetID, targetZ, plist.c_str(), petal));
  ...
  if(doRatio){
    ...
    gc2->Print(doMultipliers ? Form("%s/EventSelection2D_daisy_t%d_z%02d_%s_pz_p%d_multiplier.png", outdir.c_str(), targetID, targetZ, plist.c_str(), petal) : Form("%s/EventSelection2D_daisy_t%d_z%02d_%s_pz_p%d.png", outdir.c_str(),  targetID, targetZ, plist.c_str(), petal));
