...
//  TFile f1("Hists_ES_sys_6A_t99_z99_AntiNu.root");
//  TFile f1("Hists_EventSelection_minervame6A5runs_nosys_THIS_t99_z99_AntiNu.root");
  TFile f1("Hists_Efficiency_nosys_t99_z99_AntiNu_minervameCombinedPlaylists.root");
  TFile w("Hists_Efficiency_NonResPiOff_nosys_t99_z99_AntiNu_minervameCombinedPlaylists.root");

  MnvH2D* dataMnv=(MnvH2D*)w.Get("h_mc_pZmu_pTmu");
...
*/  histAndOpts.push_back(std::make_pair(data,     "histpe1"));
  ...
  if(doRatio) gc->SetYTitle("Ratio Efficiency Numerator");
  ...
  leg->AddEntry(dataStat, "NonResPi Off", "lpe");
...
*/
  ...
  leg2->AddEntry(dataStat, "Warped Eff Num.", "lpe");
  leg2->AddEntry(mc, "MINERvA Tune v1 Eff Num.", "l");
...
//    gc->Print(doMultipliers ? "nu-2d-xsec-comps-pt-multiplier.C" : "nu-2d-xsec-comps-pt.C");
  ...
  if(doRatio) gc2->SetYTitle("Ratio Deuterium On/MINERvA Tune v1");
