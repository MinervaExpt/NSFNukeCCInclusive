...
void makePlots(bool doMultipliers,bool doRatio, string indir, string outdir, int targetID, int targetZ, string plist, int combined)
{
  ...
  if (combined == 1){
    if(targetID==99){
      ...
      mcMnv_QE->Scale(1e-6, "width");
      mcMnv_RES->Scale(1e-6, "width");
      mcMnv_DIS->Scale(1e-6, "width");
      mcMnv_2p2h->Scale(1e-6, "width");
      mcMnv_OtherIT->Scale(1e-6, "width");
    }
    else{
      ...
      mcMnv_2p2h->Scale(1e-4, "width");
      mcMnv_OtherIT->Scale(1e-4, "width");
    }
  }
  else{
    if(targetID==99){
