...
//  TFile f(Form("%sBKGMethod1.root", location.c_str()));
  TFile f(Form("%sHists_EventSelection.root",location.c_str()));
//  TFile f(Form("%sHists_SidebandStudy.root", location.c_str()));
//  MnvH2D* data=(MnvH2D*)f.Get("signal_purityNum_pZmu_pTmu");
...
//   MnvH2D* data=(MnvH2D*)f.Get("bkg_total_pZmu_pTmu");
