...
//  ROOT::Cintex::Cintex::Enable();
  ...
  TFile f1("Hists_EventSelectionJuly15_sys__t99_z99_AntiNu.root");
//  MnvH2D* dataMnv=(MnvH2D*)f1.Get("h_data_pZmu_pTmu");
  MnvH2D* mcMnv=(MnvH2D*)f1.Get("bkg_total_pZmu_pTmu");
...
//  mc_qe->SetLineColor(mycolors[2]);
  ...
  mc_oth->SetLineColor(mycolors[2]); //colour was 4
...
//  leg->AddEntry(dataStat, "MINERvA data", "lpe");
  leg->AddEntry(mc, "Total Background", "l");
...
//  GridCanvas* gc2=plotYAxis1D(histAndOpts, "Muon Transverse Momentum (GeV/c)", "p_{||}",4,4,800,500,doMultipliers ? &multipliers2[0] : NULL);
  ...
  if(doRatio) gc2->SetYTitle("Ratio bkgType/totalBkg");
