...
//  ROOT::Cintex::Cintex::Enable();
  ...
  MnvH2D* mcMnv=(MnvH2D*)f1.Get("signal_purityNum_pZmu_pTmu");
  ...
  MnvH2D* mcMnv_qe = (MnvH2D*)f1.Get("signal_QE_pZmu_pTmu");//Get from N track
  MnvH2D* mcMnv_res = (MnvH2D*)f1.Get("signal_resonant_pZmu_pTmu");//Get from N track
  MnvH2D* mcMnv_dis_dis = (MnvH2D*)f1.Get("signal_trueDIS_pZmu_pTmu");//Get from N track
  MnvH2D* mcMnv_dis_sis = (MnvH2D*)f1.Get("signal_softDIS_pZmu_pTmu");//Get from N track
  MnvH2D* mcMnv_2p2h = (MnvH2D*)f1.Get("signal_2p2h_pZmu_pTmu");//Get from N track
  MnvH2D* mcMnv_oth = (MnvH2D*)f1.Get("signal_other_pZmu_pTmu");//Get from N track
