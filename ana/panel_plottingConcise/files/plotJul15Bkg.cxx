...
//  ROOT::Cintex::Cintex::Enable();
  ...
  MnvH2D* mcMnv=(MnvH2D*)f1.Get("bkg_totalpZmu_pTmu");
  ...
  MnvH2D* mcMnv_qe = (MnvH2D*)f1.Get("bkg_QEpZmu_pTmu");//Get from N track
  MnvH2D* mcMnv_res = (MnvH2D*)f1.Get("bkg_resonantpZmu_pTmu");//Get from N track
  MnvH2D* mcMnv_dis_dis = (MnvH2D*)f1.Get("bkg_trueDISpZmu_pTmu");//Get from N track
  ...
  MnvH2D* mcMnv_oth = (MnvH2D*)f1.Get("bkg_otherpZmu_pTmu");//Get from N track
...
//  histAndOpts.push_back(std::make_pair(data,     "histpe1"));
  ...
  if(doRatio) gc->SetYTitle("Ratio intType/Total Background");
...
//    gc->Print(doMultipliers ? "nu-2d-xsec-comps-pt-multiplier.C" : "nu-2d-xsec-comps-pt.C");
  ...
  if(doRatio) gc2->SetYTitle("Ratio intType/Total Background");
