...
//  mc_bkg->SetLineColor(mycolors[8]);
  ...
  mc->SetLineWidth(0);
  mc_qe->SetLineWidth(0);
  mc_res->SetLineWidth(0);
  mc_dis_dis->SetLineWidth(0);
  mc_dis_sis->SetLineWidth(0);
  mc_oth->SetLineWidth(0);
...
//  histAndOpts.push_back(std::make_pair(dataStat, "histpe1"));
  histAndOpts.push_back(std::make_pair(data,       "graphe3"));
  histAndOpts.push_back(std::make_pair(dataStat,       "graph0LX"));
