...
${CMTROOT}/mgr/cmt cleanup -sh -pack=NSFNukeCCInclusive -version=${MINERVA_RELEASE} -path=/minerva/app/users/anezkak/cmtuser/Minerva_v22r1p1_MADNew/Ana $* >${tempfile}; . ${tempfile}
/bin/rm -f ${tempfile}
